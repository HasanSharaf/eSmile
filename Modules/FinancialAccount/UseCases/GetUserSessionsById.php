...
use Modules\Session\Http\Resources\GetAllUserSessionsResource;
    ...
    **/
    ...
    public function execute($user_id)
    {
        try {
            ...
            return new UseCaseResult(ResponseStatus::successCode, new GetAllUserSessionsResource($sessions), count([$sessions]), '');
        } catch (\Throwable $th) {
